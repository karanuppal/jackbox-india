...
| 2026-07-26 | **§3.4 first-visit softening (fleet playtest):** a floor with any first-time visitor avoids the pure-luck chai when other legal games exist — a 90-second luck permadeath is whiplash; ghost correct-answer feedback now explains that aatma money buys finale head starts (§3.5/§3.6); VIP play-again is a two-tap confirm. Ghost-downtime prediction bets logged as future work. |
